...
describe('AxiosHttpClient', () => {
  ...
  describe('get', () => {
    ...
    it('Should call axios.get with correct values', async () => {
      const { url, queryParams, headers } = mockGetRequest()
      const sut = makeSut()
      await sut.get({ url, queryParams, headers })
  ...
  describe('put', () => {
    ...
    it('Should return the correct error response when axios.put throws a known error', async () => {
      const sut = makeSut()
  ...
  describe('delete', () => {
    ...
    it('Should return the correct error response when axios.delete throws a known error', async () => {
      const sut = makeSut()
