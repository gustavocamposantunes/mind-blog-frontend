...
import type { UpdateProfileParams } from '@/domain/usecases/user/update-profile.usecase'
...
const ProfileForm: React.FC<ProfileFormProps> = ({ profile, mutate }) => {
