...
const mockArticleData = {
  ...
  description:
    'Um guia completo para iniciantes em React, cobrindo componentes, hooks e muito mais.',
...
export const LongTitle: Story = {
  args: {
    ...mockArticleData,
    title:
      'Como começar com React: Um guia completo para iniciantes que desejam aprender a framework mais popular do momento',
  },
}
